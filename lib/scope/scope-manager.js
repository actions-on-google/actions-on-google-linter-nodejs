 ...
 * linter manage metadata across scopes coming from if-statements, try-catch etc.
 * Concrete scope managers will implement "account" method to keep track of a particular
 * metadata, such as # of Simple Responses in the scope, or whether a certain value is set
